...
class TestHitAtK:
    def test_hit_when_correct_doc_first(self):
        docs = [make_doc("data/TSLA-Q4-2025-Update.pdf"), make_doc("other.pdf")]
        assert hit_at_k(docs, "TSLA-Q4-2025-Update.pdf") == 1

    def test_hit_when_correct_doc_last(self):
        docs = [make_doc("other.pdf"), make_doc("data/TSLA-Q4-2025-Update.pdf")]
        assert hit_at_k(docs, "TSLA-Q4-2025-Update.pdf") == 1

    def test_miss_when_correct_doc_absent(self):
        docs = [make_doc("other.pdf"), make_doc("another.pdf")]
        assert hit_at_k(docs, "TSLA-Q4-2025-Update.pdf") == 0

    def test_empty_retrieved_list(self):
        assert hit_at_k([], "TSLA-Q4-2025-Update.pdf") == 0

    def test_partial_source_match(self):
        docs = [make_doc("data/TSLA-Q4-2025-Update.pdf")]
        assert hit_at_k(docs, "TSLA-Q4-2025") == 1
...
class TestMRR:
    def test_rank_1(self):
        docs = [make_doc("data/TSLA-Q4-2025-Update.pdf")]
        assert mean_reciprocal_rank(docs, "TSLA-Q4-2025-Update.pdf") == pytest.approx(1.0)

    def test_rank_2(self):
        docs = [make_doc("other.pdf"), make_doc("data/TSLA-Q4-2025-Update.pdf")]
        assert mean_reciprocal_rank(docs, "TSLA-Q4-2025-Update.pdf") == pytest.approx(0.5)

    def test_rank_3(self):
        docs = [make_doc("a.pdf"), make_doc("b.pdf"), make_doc("data/TSLA-Q4-2025-Update.pdf")]
        assert mean_reciprocal_rank(docs, "TSLA-Q4-2025-Update.pdf") == pytest.approx(1 / 3)

    def test_not_found_returns_zero(self):
        docs = [make_doc("other.pdf")]
        assert mean_reciprocal_rank(docs, "TSLA-Q4-2025-Update.pdf") == pytest.approx(0.0)

    def test_empty_list_returns_zero(self):
        assert mean_reciprocal_rank([], "TSLA-Q4-2025-Update.pdf") == pytest.approx(0.0)
...
class TestEvaluateRetriever:
    ...
    def test_perfect_retriever(self):
        ...
        dataset = [{"question": "Q1?", "source": "TSLA-Q4-2025-Update.pdf"}]
    ...
    def test_partial_hits(self):
        good_doc = make_doc("data/TSLA-Q4-2025-Update.pdf")
        ...
        dataset = [
            {"question": "Q1?", "source": "TSLA-Q4-2025-Update.pdf"},
            {"question": "Q2?", "source": "TSLA-Q4-2025-Update.pdf"},
        ]
